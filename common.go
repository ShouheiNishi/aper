...
type fieldParameters struct {
	...
	enumExtensionUpperBound *uint64 // maximum value for extension value of ENUMERATED
}
...
func parseFieldParameters(str string) (params fieldParameters) {
	for _, part := range strings.Split(str, ",") {
		...
		case strings.HasPrefix(part, "enumExtensionUpperBound:"):
			i, err := strconv.ParseUint(part[24:], 10, 64)
			if err == nil {
				params.enumExtensionUpperBound = new(uint64)
				*params.enumExtensionUpperBound = i
			}
		}
	}
	return params
